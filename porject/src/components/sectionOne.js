            ...
            <div className="backGrad h-screen">
                <div className="p-10 flex flex-row justify-between">
                    <div className="basis-1/2">
                        <a href="../pano/index.html">
                            <img
                                alt="360 logo"
                                src={require("../images/360 Tour Button.png")}
                            />
                        </a>
                        <img
                            alt="logo"
                ...
                <div className="text-white text-center mt-44">
                    ...
                    <p className="mt-10 m-auto text-[16px] max-w-screen-md">
                        Whether you're looking for a spacious family home or a
                        sleek and stylish living space. Our properties feature
